...
for f in test_csv_files:
    ...
    # saving images
    test_path = r'G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Testing Set\ALPHA\Current RI'
    test_files = os.listdir(test_path)
    i = i+1

    if os.path.exists(test_path+fr"\ALPHA cRI {i}.png"):
        plt.imsave(test_path+fr'\ALPHA cRI {i+1}.png'.format(int()), test_img)
    else:
        plt.imsave(test_path+fr'\ALPHA cRI {i}.png', test_img)
...
for f in test_csv_files:
    ...
    # saving images
    test_path = r'G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Testing Set\ALPHA\Possible RI'
    test_files = os.listdir(test_path)
    i = i+1

    if os.path.exists(test_path+fr"\ALPHA pRI {i}.png"):
        plt.imsave(test_path+fr'\ALPHA pRI {i+1}.png'.format(int()), test_img)
    else:
        plt.imsave(test_path+fr'\ALPHA pRI {i}.png', test_img)
...
for f in test_csv_files:
    ...
    # saving images
    test_path = r'G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Testing Set\ALPHA\No RI'
    test_files = os.listdir(test_path)
    i = i+1

    if os.path.exists(test_path+f"\ALPHA nRI {i}.png"):
        plt.imsave(test_path+fr'\ALPHA nRI {i+1}.png'.format(int()), test_img)
    else:
        plt.imsave(test_path+fr'\ALPHA nRI {i}.png', test_img)
