...
for f in undergoing_csv_files:
    ...
    # saving images
    undergoing_path = 'G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Training Set\Current RI'
...
for f in likely_csv_files:
    ...
    # saving images
    likely_path = 'G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Training Set\Possible RI'
...
RI_dataset = tf.keras.preprocessing.image_dataset_from_directory('G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Training Set', image_size=(300,300), batch_size=32)
