...
path = os.getcwd()
# training csv files
undergoing_csv_files = glob.glob(os.path.join(r"D:\Science Research 2\MIMIC-TC Dataset v3\Training Dataset\Currently Undergoing RI","*.csv"))
likely_csv_files = glob.glob(os.path.join(r"D:\Science Research 2\MIMIC-TC Dataset v3\Training Dataset\Likely to Undergo RI","*.csv"))
notL_csv_files = glob.glob(os.path.join(r"D:\Science Research 2\MIMIC-TC Dataset v3\Training Dataset\Likely Not to Undergo RI","*.csv"))
...
# Arthur csv processing
Arthur_test_csv_files = glob.glob(os.path.join(r"D:\Science Research 2\MIMIC-TC Dataset v3\Testing Dataset\Arthur","*.csv"))
for f in Arthur_test_csv_files:
    # read the csv file
    test_f = pd.read_csv(f, header=None)
    ...
    # saving images
    Arthur_path = "G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Testing Set\Arthur"
    Arthur_files = os.listdir(Arthur_path)
    i = i+1

    if os.path.exists(Arthur_path+f"\Arthur {i}.png"):
        plt.imsave(Arthur_path+f'\Arthur {i+1}.png'.format(int()), test_img)
    else:
        plt.imsave(Arthur_path+f'\Arthur {i}.png', test_img)

# resetting file naming variable
i=0

# Arthur files are processed
print('''Arthur files have been processed''')

# Bertha csv processing
Bertha_test_csv_files = glob.glob(os.path.join(r"D:\Science Research 2\MIMIC-TC Dataset v3\Testing Dataset\Bertha","*.csv"))
for f in Bertha_test_csv_files:
    # read the csv file
    test_f = pd.read_csv(f, header=None)
    ...
    # saving images
    Bertha_path = "G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Testing Set\Bertha"
    Bertha_files = os.listdir(Bertha_path)
    i = i+1

    if os.path.exists(Bertha_path+f"\Bertha {i}.png"):
        plt.imsave(Bertha_path+f'\Bertha {i+1}.png'.format(int()), test_img)
    else:
        plt.imsave(Bertha_path+f'\Bertha {i}.png', test_img)

# resetting file naming variable
i=0

# Bertha files are processed
print('''Bertha files have been processed''')

# BETA csv processing
BETA_test_csv_files = glob.glob(os.path.join(r"D:\Science Research 2\MIMIC-TC Dataset v3\Testing Dataset\BETA","*.csv"))
for f in BETA_test_csv_files:
    # read the csv file
    test_f = pd.read_csv(f, header=None)
    ...
    # saving images
    BETA_path = "G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Testing Set\BETA"
    BETA_files = os.listdir(BETA_path)
    i = i+1

    if os.path.exists(BETA_path+f"\BETA {i}.png"):
        plt.imsave(BETA_path+f'\BETA {i+1}.png'.format(int()), test_img)
    else:
        plt.imsave(BETA_path+f'\BETA {i}.png', test_img)

# resetting file naming variable
i=0

# BETA files are processed
print('''BETA files have been processed''')
...
Arthur_dataset = tf.keras.preprocessing.image_dataset_from_directory('G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Testing Set\Arthur', image_size=(300,300))
print("Loaded Arthur Dataset")

Bertha_dataset = tf.keras.preprocessing.image_dataset_from_directory('G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Testing Set\Bertha', image_size=(300,300))
print("Loaded Bertha Dataset")

BETA_dataset = tf.keras.preprocessing.image_dataset_from_directory('G:\Python Projects\Science Research Project\MIMIC-TC Dataset v3\Testing Set\BETA', image_size=(300,300))
